...
> [!CAUTION]
> Для цієі версіі має бути доступ до `composer` для встановлення модулів. Якщо доступу не має - використовуйте гілку https://github.com/alexlansovich/genset/tree/master-full
...
`git clone https://github.com/alexlansovich/genset.git` 
